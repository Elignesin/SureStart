...
*3/2/21* The notebook for today's action item is added to the repository. This model is adapted from https://medium.com/swlh/emotion-detection-using-opencv-and-keras-771260bbd7f7 and is shortened because it took forever to train (and still took a long time even after it was shortened.
